...
sudo apt-get -y install git autoconf libtool automake build-essential mono-devel gettext zip unzip mono-xsp
sudo apt-get -y install bash zsh curl
...
echo "xsp -root /home/vagrant/Home/samples/latest/Hello"
